...
public class SrcCodeVisitor extends VoidVisitorAdapter<SrcCodeVisitor.Context> {
    ...
    public static class Context implements Cloneable {
        ...
        /**
         * local class count tracker not deep cloned: should be refreshed for each new class context
         */
        ...
        /**
         * signature to method id map in current class not deep cloned: should be unmodifiable
         */
    ...
    private void visitCallableDeclaration(CallableDeclaration<?> n, String name,
        ...
        // collect start line and end line
        ms.startLine = n.getRange().get().begin.line;
        ms.endLine = n.getRange().get().end.line;
